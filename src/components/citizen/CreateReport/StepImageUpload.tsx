import { Camera, ChevronRight, Upload, X, Link2 } from 'lucide-react';
...
export function StepImageUpload({ imagePreview, onUpload, onRemove, onNext, imageUrl, onImageUrlChange, onUseImageUrl }: StepImageUploadProps) {
  return (
    <Card className="p-8">
